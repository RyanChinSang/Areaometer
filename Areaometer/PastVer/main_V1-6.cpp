...
int main()
{
	...
	} //show list option ONLY if another mode is accessed and user would practically require the list of shapes again
...
-Added primitive SystemCLS functionality - need some sort of memory code
-Fixed version name
